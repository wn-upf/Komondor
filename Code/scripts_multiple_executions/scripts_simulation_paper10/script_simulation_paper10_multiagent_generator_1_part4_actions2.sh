...
echo ""
echo "***********************************************************************"
echo "PAPER #10 - Multiagent generator v1 - part 4"
echo "***********************************************************************"
echo ""
...
do
	...
	do
		...
		for MAB_ALG in "explfirst" "epsilon"
			...
			for (( SCENARIO=76; SCENARIO<=100; SCENARIO++ ))
			do

				echo "          * scenario: $SCENARIO/100"
