...
do 
	echo "- executing ${array[executing_ix]} (${executing_ix}/${file_ix})"
	./komondor_main ../input/input_paper10/nodes/${array[executing_ix]} ../input/input_paper10/agents_action_space2_ucb.csv ../output/script_output.txt sim_action_space2_ucb_${array[executing_ix]} 0 1 1 1 1 $SIM_TIME $SEED >> ../output/logs_console.tx
done
echo ""
...
do 
	echo "- executing ${array[executing_ix]} (${executing_ix}/${file_ix})"
	./komondor_main ../input/input_paper10/nodes/${array[executing_ix]} ../input/input_paper10/agents_action_space2_exp3.csv ../output/script_output.txt sim_action_space2_exp3_${array[executing_ix]} 0 1 1 1 1 $SIM_TIME $SEED >> ../output/logs_console.tx
done
echo ""
