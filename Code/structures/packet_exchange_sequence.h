...
struct PacketExchangeSequence {
	int 	   transmission_mode;	///> Transmission mode (TRANSMISSION_MODE_NO_RTS_CTS, TRANSMISSION_MODE_RTS_CTS, etc.)	
...
static const PacketExchangeSequence IEEE_802_11_COBF_COSR = {
	TRANSMISSION_MODE_COBF_COSR,
	6,
	{PACKET_TYPE_ICF, PACKET_TYPE_ICR, PACKET_TYPE_TF,
		PACKET_TYPE_DATA, PACKET_TYPE_ACK_TF, PACKET_TYPE_ACK, -1, -1},
