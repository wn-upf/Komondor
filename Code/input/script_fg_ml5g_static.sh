...
do 
	...
	do 
		...
		./komondor_main ../input/fg_ml5g/centralized_graph_coloring/input_system_conf.csv ../input/fg_ml5g/centralized_graph_coloring/random_scenarios/${array_nodes[executing_ix_nodes]} ../output/script_output_basic_scenarios.txt sim_${executing_ix_nodes}.csv 0 0 0 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	done
done
