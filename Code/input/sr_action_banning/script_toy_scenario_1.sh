...
cd input/sr_action_banning/toy_scenario_1/
pwd
...
do 
	...
	./komondor_main ../input/sr_action_banning/toy_scenario_1/${array[executing_ix]} ../output/script_output.txt sim_${array[executing_ix]} 0 0 0 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
echo ""
