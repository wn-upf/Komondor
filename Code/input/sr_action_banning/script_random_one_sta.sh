...
do 
	...
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo "- EXECUTING ${array[executing_ix]} (${executing_ix}/${file_ix})"
	./komondor_main ../input/sr_action_banning/random/one_sta/sce2/${array[executing_ix]} ../input/sr_action_banning/agents_files/agents_decentralized_random.csv ../output/script_output_RND_1STA_selfish.txt sim_${array[executing_ix]} 0 1 1 1 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
echo ""
echo 'OUTPUT FILE SAVED IN /output/script_output_RND_1STA_selfish.txt'
echo ""
echo ""
...
do 
	...
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo "- EXECUTING ${array[executing_ix]} (${executing_ix}/${file_ix})"
	./komondor_main ../input/sr_action_banning/random/one_sta/sce2/${array[executing_ix]} ../input/sr_action_banning/agents_files/agents_centralized_random.csv ../output/script_output_RND_1STA_cost.txt sim_${array[executing_ix]} 0 1 1 1 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
echo ""
echo 'OUTPUT FILE SAVED IN /output/script_output_RND_1STA_cost.txt'
echo ""
echo ""
