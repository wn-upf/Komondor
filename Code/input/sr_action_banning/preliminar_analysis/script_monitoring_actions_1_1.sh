...
cd input/sr_action_banning/preliminar_analysis/toy_scenario_1_all_comb_1/
pwd
...
do 
	...
	./komondor_main ../input/sr_action_banning/preliminar_analysis/toy_scenario_1_all_comb_1/${array[executing_ix]} ../input/sr_action_banning/preliminar_analysis/agents_decentralized_monitor_1.csv ../output/script_output.txt sim_$(printf %02d $executing_ix) 0 0 1 0 1 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
echo ""
