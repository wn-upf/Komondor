...
cd input/sr_action_banning/random/one_sta/sce1a
pwd
...
do 
	...
	./komondor_main ../input/sr_action_banning/random/one_sta/sce1a/${array[executing_ix]} ../input/sr_action_banning/agents_files/agents_centralized_random.csv ../output/script_output_RND_1STA_cost.txt sim_${array[executing_ix]} 0 0 1 1 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
echo ""
