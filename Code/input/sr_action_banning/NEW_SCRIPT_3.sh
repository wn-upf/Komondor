...
cd input/sr_action_banning/NEW_INPUTS/grid_d1-2_l=10000
pwd
...
do 
	...
	./komondor_main ../input/sr_action_banning/NEW_INPUTS/grid_d1-2_l=10000/${array[executing_ix]} ../input/sr_action_banning/agents_files/agents_centralized_random.csv ../output/script_output_grid_d1-2_l=10000_cost.txt sim_${array[executing_ix]} 0 1 1 1 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
echo ""
echo 'OUTPUT FILE SAVED IN /output/script_output_grid_d1-2_l=10000_cost.txt'
echo ""
echo ""
