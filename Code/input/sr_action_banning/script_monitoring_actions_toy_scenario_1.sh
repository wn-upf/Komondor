...
cd input/sr_action_banning/toy_scenario_2_all_comb_2/
pwd
...
do 
	...
	./komondor_main ../input/sr_action_banning/toy_scenario_2_all_comb_2/${array[executing_ix]} ../input/sr_action_banning/agents_decentralized_monitor_2.csv ../output/script_output.txt sim_$executing_ix 0 0 1 0 1 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
echo ""
