...
do 
	...
	./komondor_main ../input/test_thesis/11ax_sr/${array[executing_ix]} ../input/test_thesis/agents_rtot30.csv ../output/script_output_rtot30.txt sim_${array[executing_ix]} 0 0 0 1 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
