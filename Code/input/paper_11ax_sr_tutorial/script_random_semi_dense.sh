...
cd input/paper_11ax_sr_tutorial/input_files/2_random_semi_dense/traffic_load_1000
...
# get input files path in folder 'script_input_files'
cd input/paper_11ax_sr_tutorial/input_files/2_random_semi_dense/traffic_load_5000
pwd
...
do 
	...
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo "- EXECUTING ${array[executing_ix]} (${executing_ix}/${file_ix})"
	./komondor_main ../input/paper_11ax_sr_tutorial/input_files/input_system_conf_full_buffer.csv ../input/paper_11ax_sr_tutorial/input_files/2_random_semi_dense/traffic_load_1000/${array[executing_ix]} ../output/traffic_load_10000/script_output.txt sim_${array[executing_ix]} 0 0 0 1 $SIM_TIME $SEED >> ../output/traffic_load_1000/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
echo ""
