...
cd input/paper_11ax_sr_tutorial/input_files/random_scenarios/2_random_semi_dense/traffic_load_1000
...
# get input files path in folder 'script_input_files'
cd input/paper_11ax_sr_tutorial/input_files/random_scenarios/2_random_semi_dense/traffic_load_5000
pwd
