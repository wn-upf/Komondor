...
cd input/unam/fixed_grid_random_action
pwd
...
do 
	...
	./komondor_main ../input/unam/input_system_conf.csv ../input/unam/fixed_grid_random_action/${array[executing_ix]} ../output/script_output.txt sim_${array[executing_ix]} 0 0 0 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
echo ""
