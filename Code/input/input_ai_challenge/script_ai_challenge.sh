...
cd input/input_ai_challenge/sce1a
pwd
...
do 
	...
	./komondor_main ../input/input_ai_challenge/sce1a/${array[executing_ix]} ../output/script_output_sce1a.txt sim_${array[executing_ix]} 0 0 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
...
# get input files path in folder 'script_input_files'
cd ..
cd input/input_ai_challenge/sce1b
pwd
...
do 
	...
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo "- EXECUTING ${array[executing_ix]} (${executing_ix}/${file_ix})"
	./komondor_main ../input/input_ai_challenge/sce1b/${array[executing_ix]} ../output/script_output_sce1b.txt sim_${array[executing_ix]} 0 0 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
...
# get input files path in folder 'script_input_files'
cd ..
cd input/input_ai_challenge/sce1c
pwd
...
do 
	...
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo "- EXECUTING ${array[executing_ix]} (${executing_ix}/${file_ix})"
	./komondor_main ../input/input_ai_challenge/sce1c/${array[executing_ix]} ../output/script_output_sce1c.txt sim_${array[executing_ix]} 0 0 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
