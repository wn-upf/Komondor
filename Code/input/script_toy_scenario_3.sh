...
cd input/script_input_files/toy_scenario_3c
pwd
...
do 
	...
	./komondor_main ../input/input_system_conf.csv ../input/script_input_files/toy_scenario_3c/${array[executing_ix]} ../output/script_output.txt sim_${array[executing_ix]} 0 0 0 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
echo ""
