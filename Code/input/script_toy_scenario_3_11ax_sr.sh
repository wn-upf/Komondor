...
cd input/agents/test_centralized_action_banning/toy_scenario_3/11ax_sr
pwd
...
do 
	...
	./komondor_main ../input/agents/test_centralized_action_banning/input_system_conf.csv ../input/agents/test_centralized_action_banning/toy_scenario_3/11ax_sr/${array[executing_ix]} ../output/script_output.txt sim_${array[executing_ix]} 0 0 0 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
echo ""
