...
cd input/input_students_projects/random_scenarios
pwd
...
do 
	...
	./komondor_main ../input/input_students_projects/input_system_conf.csv ../input/input_students_projects/random_scenarios/${array[executing_ix]} ../output/script_output.txt sim_${array[executing_ix]} 0 0 0 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
echo ""
