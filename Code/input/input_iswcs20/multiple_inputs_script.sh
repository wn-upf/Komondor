...
cd input/input_iswcs20/all_combinations/
pwd
...
do 
	...
	./komondor_main ../input/input_iswcs20/all_combinations/${array[executing_ix]} ../output/script_output.txt sim_${array[executing_ix]} 0 0 1 $SIM_TIME $SEED >> ../output/logs_console.txt
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
	echo ""
done
echo ""
