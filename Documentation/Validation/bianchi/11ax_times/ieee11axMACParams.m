...
function [T_DIFS,T_SIFS,Te,L_MH,L_BACK,L_RTS,L_CTS,L_SF,L_MD,L_TB, L_ACK] = ieee11axMACParams()
    ...
    %   - L_ACK: length of ACK for no aggregation [bits]
    ...
    L_MD = 32;
    L_MH = 320;
    % L_TB = 18; WARNING! This should be the value just to much ns3 results
    L_TB = 0;
    L_BACK = 432;
    L_ACK = 112;
