 ...
 */
public class Nodes_rectangular_generator_agents_test {
    ...
    static int traffic_load;       // IEEE protocol type
    // -------------------
    ...
    public static void genearate_file(String csv_filepath_output)
     ...
     public static void genearate_agents_file(String csv_filepath_output)
            throws UnsupportedEncodingException, FileNotFoundException, IOException {
        ...
        String csv_header_line = "wlan_code" + CSV_SEPARATOR
                + "time_between_requests" + CSV_SEPARATOR
                + "actions_primary_channel" + CSV_SEPARATOR
                + "actions_cca" + CSV_SEPARATOR
                + "actions_tx_power" + CSV_SEPARATOR
                + "actions_dcb_policy" + CSV_SEPARATOR
                + "reward";
        ...
        for (int w = 0; w < num_wlans; w++) {
            ...
            wlan = wlan_container[w];
            line = wlan.wlan_code + CSV_SEPARATOR
                    + "0.25" + CSV_SEPARATOR // time_between_requests
                    + "0,1,2,3,4,5,6,7" + CSV_SEPARATOR // actions_primary_channel
                    + "-82" + CSV_SEPARATOR // actions_cca
                    + "15" + CSV_SEPARATOR // actions_tx_power
                    + "0,4,6" + CSV_SEPARATOR // actions_dcb_policy
                    + "1";  // reward
    ...
    public static void main(String args[]) throws IOException {
        ...
        for(int out_ix = 0; out_ix < num_outputs; out_ix++){
            ...
            generate_wlans();
            output_path = "input_nodes_n" + num_wlans + "_s" + out_ix + ".csv";
            System.out.println("output_path: " + output_path);
            genearate_file(output_path);
     
        }

        String agents_output_path = "agents.csv";
        genearate_agents_file(agents_output_path);
