...
public class AI_challenge_sce2 {
...
//                System.out.println("   + STA: " + bss.stas_position_list[n]);
    ...
    public static void main(String args[]) throws IOException {
        ...
        String input_path = "./input_constructor/template_ai_challenge_sce2a.csv";
        ...
        for (int i = 0; i < num_random_deployments; ++i) {   
            ...
            output_path = "./output/input_nodes_sce2a_deployment_" + String.format("%03d", i) + ".csv";
