...
public class NEW_single_office_enterprise_scenario_11ax {
        ...
        for (int i = 0; i < num_rows; i ++) {
            for (int j = 0; j < num_columns; j ++) {                
                for (int a = 0; a < number_of_aps_per_office; a ++) {
                    ...
                    aps_position_list[a] = point;
                    System.out.println("AP" + a + "'s position = " + aps_position_list[a]);
                    // Define cubicles (4 per AP)
                    for(int sta_ix = 0; sta_ix < 4; sta_ix ++) {
                        ...
                        point_ceil.setLocation(aps_position_list[a].x + ceil_shifts_inter[k][0], 
                            aps_position_list[a].y + ceil_shifts_inter[k][1]);
//                        System.out.println(" + Centre of ceil " + k + " = " + point_ceil);
                        ...
                        for (int s = 0; s < 4; s ++) {
                            ...
                            stas_position_list[a][sta_ix] = point_sta;
