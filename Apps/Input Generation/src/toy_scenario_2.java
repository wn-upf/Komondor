...
/*
 * Program for Toy scenario 2 of the paper "Spatial Reuse in IEEE 802.11ax: 
Analysis, Challenges and Opportunities"
 * - Scenario considering:
 *      + Spatial Reuse Groups (SRG) for OBSS PD-based SR 
 *      + Tune both SRG and non-SRG OBSS PD thresholds
 */
...
public class toy_scenario_2 {
    ...
    public static void generate_wlans(int srg_obss_pd_input, int non_srg_obss_pd_input) {
        ...
        for (int w = 0; w < num_wlans; w++) {
            ...
            if (w == 0) { // If WLAN A
                ...
                y = 0;
                z = 0;
            } else if (w == 1) { // If WLAN B
                x = 8;
                y = 0;
                z = 0;
            } else if (w == 2) { // If WLAN C
                x = 6;
                y = 5;
                z = 0;
            }  
                                               
            // Generate the WLAN object
    ...
    public static void main(String args[]) throws IOException {
        ...
        String input_path = "./input_constructor/toy_scenarios/input_template_toy_scenario_2.csv";
