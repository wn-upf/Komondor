...
public class SR_RANDOM_2 {
    ...
    public static void generate_wlans(int srg_obss_pd, int non_srg_obss_pd, Point2D.Double[] aps_position_list, 
...
//        }
        ...
        for (int w = 0; w < num_wlans; w++) {
            ...
            if (w == 0) {
                ...
                double distance_with_w0 = getDistance(wlan_aux.x, wlan_container[0].x, 
                    wlan_aux.y, wlan_container[0].y, 0, 0);
                if (distance_with_w0 < 8) {
                    wlan_aux.spatial_reuse_group = 1;
                } else {
