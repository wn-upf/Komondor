 ...
 */
int* getChannelOccupancyByCCA(int *channels_free, int min_channel_allowed, int max_channel_allowed,
	...
	return channels_free;

}


double* updatePowerReceivedPerNode(double *power_received_per_node, Notification notification,
	...
	return power_received_per_node;
 ...
 */
double* applyInterferenceModel(double *total_power, Notification notification, Logger node_logger,
 ...
 * - update_type: type of power update (sum or subtract)
 */
double* updateChannelsPower(double *channel_power, double *power_received_per_node, Notification notification,
	...
	total_power = applyInterferenceModel(total_power, notification, node_logger,
 ...
 */
int* getTxChannelsByChannelBonding(int *channels_for_tx, int channel_bonding_model, int *channels_free,
