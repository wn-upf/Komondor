/*
 * Komondor is the main component for running KOMONDOR simulations.
 */
...
component Komondor : public CostSimEng {
	...
	public:
		...
		// Parameters entered by system file
 ...
 * - simulation_code_console: simulation code assigned to current simulation
 */
void Komondor :: Setup(double sim_time_console, int save_system_logs_console, int save_node_logs_console,
	...
	if (print_system_logs) {
		...
		printAllNodesInfo(INFO_DETAIL_LEVEL_3);
		if (print_system_logs) printf("\n\n");
	}
 ...
 * Input arguments:
 * - system_filename: system input file
 */
